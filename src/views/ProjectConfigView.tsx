  ...
  return (
    <div className="view" style={css('position:absolute;inset:0;overflow-y:auto;display:flex;justify-content:center')}>
      <div style={css(`width:640px;max-width:100%;padding:${v.pagePad}`)}>
        <button type="button" onClick={v.goProjects} style={css('display:inline-flex;align-items:center;gap:6px;font-size:13.5px;color:var(--muted);cursor:pointer;margin-bottom:14px;background:transparent;border:none;text-align:left;font:inherit')}><Icon n="back" size={15} /> Tất cả dự án</button>
        ...
        <div style={css('display:flex;flex-direction:column;gap:8px;margin-bottom:30px')}>
          <button type="button" onClick={v.openMd} style={css('display:flex;align-items:center;gap:11px;border:1px solid var(--border);border-radius:11px;background:var(--panel);padding:11px 13px;cursor:pointer;text-align:left;font:inherit')}>
          ...
          <button type="button" onClick={v.openPdf} style={css('display:flex;align-items:center;gap:11px;border:1px solid var(--border);border-radius:11px;background:var(--panel);padding:11px 13px;cursor:pointer;text-align:left;font:inherit')}>
          ...
          <button type="button" onClick={v.openCsv} style={css('display:flex;align-items:center;gap:11px;border:1px solid var(--border);border-radius:11px;background:var(--panel);padding:11px 13px;cursor:pointer;text-align:left;font:inherit')}>
          ...
          <button type="button" onClick={v.openLightbox} style={css('display:flex;align-items:center;gap:11px;border:1px solid var(--border);border-radius:11px;background:var(--panel);padding:11px 13px;cursor:pointer;text-align:left;font:inherit')}>
