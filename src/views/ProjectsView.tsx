    ...
    <div style={css('position:absolute;inset:0;overflow-y:auto;display:flex;justify-content:center')}>
      <div style={css(`width:720px;max-width:100%;padding:${v.pagePad}`)}>
        <div style={css('display:flex;align-items:flex-end;justify-content:space-between;gap:12px;margin-bottom:8px')}>
          ...
          <div onClick={v.goConv} style={css('display:flex;align-items:center;gap:6px;background:var(--ink);color:var(--bg);border-radius:10px;padding:9px 14px;font-size:13.5px;cursor:pointer;flex-shrink:0')}>
        ...
        <div onClick={v.goConv} style={css('display:flex;align-items:center;justify-content:space-between;gap:12px;padding:16px;border:1px solid var(--border);background:var(--panel);border-radius:13px;cursor:pointer;margin-bottom:10px')}>
        ...
        {v.projects.map((p, i) => (
          <div key={i} style={css('display:flex;align-items:center;justify-content:space-between;gap:10px;padding:17px 4px;border-bottom:1px solid var(--border)')}>
            <div onClick={p.open} style={css('display:flex;align-items:center;gap:12px;min-width:0;cursor:pointer;flex:1')}>
