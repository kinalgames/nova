...
export function ProviderNudge({ compact = false }: { compact?: boolean }) {
  ...
  if (compact)
    return (
      <div className="mx-auto mb-2 flex w-full max-w-[680px] flex-wrap items-center gap-x-3 gap-y-2 rounded-md border border-border bg-panel px-4 py-2.5">
  ...
  return (
    <div className="flex min-h-[58vh] flex-col items-center justify-center text-center">
      <div className="mb-4 flex size-12 items-center justify-center rounded-full border border-border bg-panel text-accent-text">
        <Icon n="plus" size={20} />
      </div>
